...
Backend-focused AI developer building real-world applications with Python, Flask, FastAPI, and LLMs. I care about writing clean, production-ready code and solving practical problems with machine learning.



- 🎓 **B.E. CSE** @ P.D.A College of Engineering, Kalaburagi (2022–2026) | CGPA: **8.08**

- 💼 Currently interning @ **Genplus Training & Consulting Services** — AI-Powered Product Recommendation System
...
`Python` · `TensorFlow` · `Keras` · `Streamlit` · `NumPy` · `Pandas`



Hybrid deep learning model combining **CNN + Random Forest** for agricultural crop yield prediction.

- Achieved **94.6% accuracy**, RMSE of 0.069, R² score of 0.94 — outperforming LSTM, Decision Tree & Linear Regression baselines

- Integrated multi-source datasets: weather patterns, soil composition, and geographic data

- Built a **Streamlit web interface** for real-time crop recommendations based on soil pH, nitrogen content, rainfall & temperature

- 📄 Published in **IRJAEH Vol. 04, Issue 01 (Jan 2026)** · [DOI: 10.47392/IRJAEH.2026.0038](https://doi.org/10.47392/IRJAEH.2026.0038)
...
- Reduced average product browsing time from **~3 hours to minutes** via LLM-driven intelligent reasoning

- Designed RESTful APIs for product search, user sessions, and AI recommendation requests

- Implemented **Google Search scraping pipeline** for real-time product data ingestion

- Connected third-party SOAP APIs and configured Supabase for auth and database management
...
Real-time voice-activated assistant with end-to-end speech recognition and text-to-speech response.
...
- Advanced **RAG pipelines** and vector database integration

- Scalable **LLM application architecture** for production systems
...
<p align="center">
  ...
  <img src="https://komarev.com/ghpvc/?username=sujaymalipatil&style=for-the-badge&color=00f7ff" alt="Profile Views"/>
